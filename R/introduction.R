...
steps_introduction_df <- function(element_name, qim_tab, appointment_view = FALSE) {
  steps_df <-
    data.frame(element = as.character(NA),
               intro = c(paste(shiny::tags$h4("GPstat! Quality Improvement Measures (QIM)"),
                               shiny::br(),
    ...
    rbind(data.frame(element = as.character(NA),
                     intro = c(paste(shiny::tags$h4("GPstat! Quality Improvement Measures (QIM)"),
                                     shiny::br(),
  ...
  if (appointment_view) {
    steps_df <- steps_df %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("Quality Improvement (QIM) Appointment view"),
                                       shiny::br(),
    ...
    steps_df <- steps_df %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("Practice Incentive Program (PIP) Quality Improvement (QIM) view"),
                                       shiny::br(),
  ...
  steps_df <- steps_df %>>%
    rbind(data.frame(element = element_name,
                     intro = c(paste(shiny::tags$h4("Demographic groupings and Old Measurements"),
                                     shiny::br(),
  ...
  if (!appointment_view) {
    steps_df <- steps_df %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("Report/List view"),
                                       shiny::br(),
  ...
  if (qim_tab == "Active") {
    steps_df <- steps_df %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("Active"),
                                       shiny::br(),
  ...
  if (qim_tab == "Diabetes") {
    steps_df <- steps_df %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("Diabetes Measures"),
                                       shiny::br(),
  ...
  if (qim_tab == "Cervical Screening") {
    steps_df <- steps_df %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("Cervical Screening"),
                                       shiny::br(),
  ...
  if (qim_tab == "15+") {
    steps_df <- steps_df %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("Age 15+ Measures"),
                                       shiny::br(),
                       ...
                       position = "auto")) %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("15+ Measures"),
                                       shiny::br(),
                                       shiny::icon("gear"), shiny::br(),
                                       "Top-right of the table view.",
                                       shiny::br(), shiny::br(),
  ...
  if (qim_tab == "65+") {
    steps_df <- steps_df %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("Age 65+ Measures"),
                                       shiny::br(),
  ...
  if (qim_tab == "COPD (Lung Disease)") {
    steps_df <- steps_df %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("COPD (Lung Disease) Measures"),
                                       shiny::br(),
  ...
  if (qim_tab == "Cardiovascular risk") {
    steps_df <- steps_df %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("Cardiovascular Risk"),
                                       shiny::br(),
                       ...
                       position = "auto")) %>>%
      rbind(data.frame(element = element_name,
                       intro = c(paste(shiny::tags$h4("Framingham Risk Equation"),
                                       shiny::br(),
