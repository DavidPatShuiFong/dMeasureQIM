...
##### QIM 65 plus fields ############################################################
.public(dMeasureQIM, "qim_65plus_list",
...
list_qim_65plus <- function(dMeasure_obj,
                            ...
                            ignoreOld = NA,
                            lazy = FALSE) {
  dMeasure_obj$list_qim_65plus(contact, date_from, date_to, clinicians,
                               min_contact, min_date, contact_type,
                               ignoreOld,
                               lazy)
}

.public(dMeasureQIM, "list_qim_65plus", function(contact = "contact",
                                                 date_from = NA,
                                                 date_to = NA,
                                                 clinicians = NA,
                                                 min_contact = NA,
  ...
  if (self$dM$emr_db$is_open()) {
    ...
    if (contact == "contact") {
      if (!lazy) {
        self$dM$list_contact_65plus(date_from, date_to, clinicians,
...
.reactive_event(dMeasureQIM, "qim_65plus_listR",
                quote(
                  shiny::eventReactive(
                    c(self$dM$contact_65plus_listR(),
                      self$qim_ignoreOldR()), {
...
.public(dMeasureQIM, "qim_65plus_list_appointments",
        data.frame(Patient = character(),
                   RecordNo = character(),
...
list_qim_65plus_appointments <- function(dMeasure_obj,
                                         ...
                                         ignoreOld = NA,
                                         lazy = FALSE) {
  dMeasure_obj$list_qim_65plus_appointments(contact, date_from, date_to, clinicians,
                                            min_contact, min_date, contact_type,
                                            ignoreOld,
                                            lazy)
}

.public(dMeasureQIM, "list_qim_65plus_appointments", function(contact = "contact",
                                                              date_from = NA,
                                                              date_to = NA,
                                                              clinicians = NA,
                                                              min_contact = NA,
...
.reactive_event(dMeasureQIM, "qim_65plus_list_appointmentsR",
                quote(
                  shiny::eventReactive(
...
.public(dMeasureQIM, "qim_65plus_report",
        data.frame(NULL,
                   stringsAsFactors = FALSE))
...
report_qim_65plus <- function(dMeasure_obj,
                              ...
                              ignoreOld = NA,
                              lazy = FALSE) {
  dMeasure_obj$report_qim_65plus(contact, date_from, date_to, clinicians,
                                 min_contact, min_date, contact_type,
                                 demographic,
                                 ignoreOld, lazy)
}
.public(dMeasureQIM, "report_qim_65plus", function(contact = "contact",
                                                   date_from = NA,
                                                   date_to = NA,
                                                   clinicians = NA,
                                                   min_contact = NA,
...
.reactive_event(dMeasureQIM, "qim_65plus_reportR",
                quote(
                  shiny::eventReactive(
                    c(self$qim_65plus_listR(),
